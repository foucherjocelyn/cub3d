SRCS	= srcs/ray_casting.c srcs/main.c srcs/init.c srcs/parsing.c srcs/ft_strcpy.c srcs/get_next_line/get_next_line.c srcs/get_next_line/get_next_line_utils.c srcs/atoi.c srcs/parsing_map.c srcs/sprite_casting.c srcs/rendering.c srcs/input.c srcs/draw_line.c srcs/errors.c srcs/init_parsing.c srcs/check_map.c
OBJS	= $(SRCS:.c=.o)
